...
<body>
	   <sys:toolbargridsingle objId="SmGoal"  permissionEdit="sm:smGoal:edit"></sys:toolbargridsingle>
		...
		>
			<div property="columns">
				...
				<div type="checkcolumn"></div>
					...
					<div name="year" field="year" vtype=""   headerAlign="center" allowSort="true" width="64" >年度
						<input property="editor" class="mini-textbox"  style="width:100%;"  />
						<input id="year-Filter" name="mini-column-filter"  property="filter" class="mini-textbox" style="width:100%;"
							   onvaluechanged="onFilterChanged" showClose="true"  oncloseclick="onFilterClose(this)"
						/>
					</div>
					<div name="orgName" field="orgName" vtype=""   headerAlign="center" allowSort="true" width="200" >班组名称
						<input property="editor" class="mini-textbox"  style="width:100%;"  />
						<input id="orgName-Filter" name="mini-column-filter"  property="filter" class="mini-textbox" style="width:100%;"
							   onvaluechanged="onFilterChanged" showClose="true"  oncloseclick="onFilterClose(this)"
						/>
					</div>
					<div name="deptId" field="deptId" vtype=""   headerAlign="center" allowSort="true" width="64" >部门id
						<input property="editor" class="mini-textbox"  style="width:100%;"  />
						<input id="deptId-Filter" name="mini-column-filter"  property="filter" class="mini-textbox" style="width:100%;"
							   onvaluechanged="onFilterChanged" showClose="true"  oncloseclick="onFilterClose(this)"
						/>
					</div>
					<div name="deptName" field="deptName" vtype=""   headerAlign="center" allowSort="true" width="200" >部门名称
						<input property="editor" class="mini-textbox"  style="width:100%;"  />
						<input id="deptName-Filter" name="mini-column-filter"  property="filter" class="mini-textbox" style="width:100%;"
							   onvaluechanged="onFilterChanged" showClose="true"  oncloseclick="onFilterClose(this)"
						/>
					</div>
					<div name="code" field="code" vtype=""   headerAlign="center" allowSort="true" width="64" >编号
						<input property="editor" class="mini-textbox"  style="width:100%;"  />
					...
					<div name="compId" field="compId" vtype=""   headerAlign="center" allowSort="true" width="64" >公司id
						<input property="editor" class="mini-textbox"  style="width:100%;"  />
						<input id="compId-Filter" name="mini-column-filter"  property="filter" class="mini-textbox" style="width:100%;"
							   onvaluechanged="onFilterChanged" showClose="true"  oncloseclick="onFilterClose(this)"
						/>
					</div>
					<div name="compName" field="compName" vtype=""   headerAlign="center" allowSort="true" width="200" >公司名称
						<input property="editor" class="mini-textbox"  style="width:100%;"  />
						<input id="compName-Filter" name="mini-column-filter"  property="filter" class="mini-textbox" style="width:100%;"
							   onvaluechanged="onFilterChanged" showClose="true"  oncloseclick="onFilterClose(this)"
						/>
					</div>
        </div>
