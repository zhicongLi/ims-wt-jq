...
<body>
	...
	<div class="print-content">		
		...
		<table id="wowtFirstTable">		    
			...
			<tr class="fire04">
				<td id="content"  class="widthValue" colspan="2" >				 	
               		 <span class="ident-number1">4.</span>动火地点及设备名称：<input readonly="true" id='location1' value="${fn:escapeXml(locationList[0])}"/><!-- value="${locationList[0]}" -->
				</td>
			</tr>
			...
			<c:forEach begin="1" end="${fn:length(contentList)-1}" var="i">
					<tr class="ident1 work02">
						<td colspan="3">
							<input  readonly="true" value="${fn:escapeXml(contentList[i])}"/><!-- value="${contentList[i]}" -->
						</td>
					</tr>					
			</c:forEach>			
		</table>
		...
		<table>
			...
			<tr >
				<td colspan="2" class="middletd">分管安全生产的领导或总工程师：
					<input size="10" readonly="true" value="${woWtFire.appCompProcLeaderName}"/>
				</td>				
			</tr>
			<tr class="date02">
		...
		<table>
			...
			<tr class="middletd">
				<td>动火部门负责人：
					<%-- <input size="10" readonly="true" value="${woWtFire.safeDeptLeaderName}"/> --%>
					<input size="10" readonly="true" value=""/>
				</td>
				<td colspan="2">消防管理部门负责人：
			...
			<tr class="middletd">
				<td>安监部门负责人：
					<%-- <input size="10" readonly="true" value="${woWtFire.safeCompSafeHealthName}"/> --%>
					<input size="10" readonly="true" value=""/>
				</td>
				<td colspan="2">分管安全生产的领导或总工程师：
					<%-- <input size="10" readonly="true" value="${woWtFire.safeCompProcLeaderName}"/> --%>
					<input size="10" readonly="true" value=""/>
				</td>				
			</tr>
			<tr class="middletd">			
		...
		<table>	 
		    ...
		    <%-- <tr>
			<td id="remark"  class="widthValue" colspan="3"><span class="ident-number2">17.</span>备注：<input id="remark1"  class="table09-put"
				readonly="true" value="${remarksList[0]}" />
			</td>
		</tr>
		<c:forEach begin="1" end="${fn:length(remarksList)-1}" var="i">
			<tr class="ident1 work02">
