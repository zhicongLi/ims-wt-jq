	...
	<header class="host header">	    
	   ...
	   <tbody>	  
		...
		<tr class="daozhadixian">
			...
			<tr>
            	<td   colspan="3">
                <span class="ident-number1">8.</span>
                	安全措施（注意事项）：<input  style="width:465px;float: right" id="zlSm1" readonly="true" value="${fn:escapeXml(zlSmList[0])}"/></td>
			</tr>
		...
		<table >
			...
			<tr >
				<td colspan="2" class="middletd">工作票签发人：	
           ...
           <tr >
				<td colspan="2" class="middletd">工作票接收人：	
           ...
           <tr>
							...
							<c:choose>
								<c:when test="${fn:length(conditionBcList)==0}">
									<c:if test="${status.first}">
										<input  readonly="true" value="无补充"/>
										<img id="#yxkb" src="${ctxStatic}/wo/icon/yxkb_yf.bmp" style="position: absolute;left:0px;margin:auto;top:35px">
									</c:if>
								</c:when>								
							</c:choose>
						</td>						
			...
			<tr class="date01">
				<td colspan="3"  >
					<san class="ident-number2">11.</san>
               		确认本工作票上述各项内容， 许可开始工作时间：					   
