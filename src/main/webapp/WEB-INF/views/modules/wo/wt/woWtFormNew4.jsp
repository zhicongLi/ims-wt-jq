			...
			<div class="mini-fit">
				<div id="datagridMain" class="mini-datagrid"
					...
					<div property="columns">
						...
						<div name="appUnitLeaderName" field="appUnitLeaderName" vtype=""
							headerAlign="center" allowSort="true" width="64"
							visible="false" hideable="true">
							单元长 <input property="editor" class="mini-textbox"
								style="width: 100%;" /> <input id="appUnitLeaderName-Filter"
								name="mini-column-filter" property="filter"
								class="mini-textbox" style="width: 100%;"
								onvaluechanged="onFilterChanged" showClose="true"
								oncloseclick="onFilterClose(this)" />
						...
						<div name="woWtDelay.delayTime" field="woWtDelay.delayTime"
							...
							allowSort="true" width="160" sortField="wwd.permit_by_name"
							>
							延期时间 <input property="editor" class="mini-textbox"
								style="width: 100%;" /> <input
						...
						<div name="woWtDelay.workLeaderName"
							...
							allowSort="true" width="100" sortField="wwd.workLeaderName"
							visible="false" hideable="true">
						...
						<div name="woWtDelay.permitByName"
							...
							allowSort="true" width="100" sortField="wwd.permitByName"
							visible="false" hideable="true">
						...
						<div class="mini-col-12">
							...
							<table class="formtable">
								<tr>
									...
									<td>状态:</td>
									<td><input name="status" id="status" class="mini-combobox" allowInput="false" enabled="true" required="false" valueField="value" textField="label" vtype="" url="${ctx}/ims-ext/sys/dict/listDataStr?type=wo_wt_status" /></td>
									<td>专业:</td>
								...
								<tr>
									<td>所属设备KKS：</td>
									<td><input name="equipLogicId" id="equipLogicId" textName="equipLogicId" allowInput="false" class="mini-buttonedit" vtype="" required="false" width="200px"
								...
								<tr>
									<td>部门：</td>
									<td><input name="orgId" id="orgId" textName="orgName" class="mini-buttonedit" width="200px"
									...
									<td>班组：</td>
									<td colspan="3"><input name="maintOrg" id="maintOrg" textName="maintOrgName" class="mini-buttonedit" vtype=""
								...
								<tr>
									...
									<td colspan=""><input style="" name="workLeader" id="workLeader" required="false" textName="workLeaderName" class="mini-buttonedit" width="200px"
									...
									<!-- <span id="safetyGuardian_lab">安全监护人：</span> --></td>
									<td>机组:</td>
								...
								<tr>
									<td>3．工作内容：</td>
									<td colspan="2"><input name="content" id="content"class="mini-textarea" vtype="" required="false" width="100%" /></td>
									<td>工作地点：</td>
									<td colspan=2>
							...
							<div class="mini-panel" title="应断开" width="auto"
								id="tabWoWtsm9List" name="tabWoWtsm9List"
								...
								<div id="gridWoWtsm9" class="mini-datagrid sGrid"
									style="width: 99.999%;"
							...
							<div class="mini-panel" title="应关闭" width="auto"
								id="tabWoWtsm10List" name="tabWoWtsm10List"
								showCollapseButton="true" onbuttonclick="onPanelButtonClick"
								showFooter="true">
								<sys:toolbargridsub girdId="gridWoWtsm1" permissionEdit="wo:woWtSm:edit"></sys:toolbargridsub>								
								<div id="gridWoWtsm10" class="mini-datagrid sGrid"
									style="width: 99.999%;"
							...
							<div class="mini-panel" title="应开启" width="auto"
								id="tabWoWtsm11List" name="tabWoWtsm11List"
								showCollapseButton="true" onbuttonclick="onPanelButtonClick"
								showFooter="true">
								<sys:toolbargridsub girdId="gridWoWtsm11" permissionEdit="wo:woWtSm:edit"></sys:toolbargridsub>								
								<div id="gridWoWtsm11" class="mini-datagrid sGrid"
									style="width: 99.999%;"
							...
							<div class="mini-panel" title="应将下列截门停电、加锁，并挂“禁止操作，有人工作”警告牌：" width="auto"
								id="tabWoWtsm12List" name="tabWoWtsm12List"
								showCollapseButton="true" onbuttonclick="onPanelButtonClick"
								showFooter="true">
								<sys:toolbargridsub girdId="gridWoWtsm12" permissionEdit="wo:woWtSm:edit"></sys:toolbargridsub> 								
								<div id="gridWoWtsm12" class="mini-datagrid sGrid"
									style="width: 99.999%;"
							...
							<div class="mini-panel" title="其他安全措施：" width="auto"
								id="tabWoWtsm14List" name="tabWoWtsm14List"
								showCollapseButton="true" onbuttonclick="onPanelButtonClick"
								showFooter="true">
								<sys:toolbargridsub girdId="gridWoWtsm14" permissionEdit="wo:woWtDpsm:edit"></sys:toolbargridsub> 									
								<div id="gridWoWtsm14" class="mini-datagrid sGrid"
									style="width: 99.999%;"
									...
									<div property="columns">
										...
										<div name="seqNo" field="seqNo" vtype="int"
											headerAlign="center" allowSort="true" width="64"
											visible="false" hideable="true">序号 
											<input property="editor" class="mini-textbox" style="width: 100%;" /> 
							...
							<table class="formtable">
								<tr>
									<td>工作票签发人：</td>
									<td colspan="2">
										<!-- <input name="wtSignerName" id="wtSignerName"  class="mini-textbox" vtype = "" allowInput="false"  />
								...
								<tr>
									<td>工作票接收人：</td>
									<td colspan="2">
										<!-- <input name="wtReceiveName" id="wtReceiveName"  class="mini-textbox" vtype = "" allowInput="false"  />
							...
							<div class="mini-panel" title="运行人员补充的安全措施：" width="auto"
							...
							<table class="formtable">
								<tr>
									<td>10．批准工作时间：</td>
									<!-- <td colspan="7"><input style="width: 200px;"
										allowInput="false" name="appEndTime" id="appEndTime"
										class="mini-datepicker" showTime="true" vtype=""
										format="yyyy-MM-dd HH:mm:ss" required="false" /></td> -->
									<td align="right">开始时间：</td>
									<td>
								...
								<tr>
									...
									<td colspan="2">
										<!-- <input name="appDutyLeaderName" id="appDutyLeaderName"  class="mini-textbox" vtype = "" allowInput="false"  />
									...
									<td>
										<input name="smPermitByName" id="smPermitByName"  class="mini-textbox" vtype = "" allowInput="false"  />
								        <a class="mini-button"  id="smPermitByName_" name="smPermitByName_" value="3" onClick="sign(this.name,this.value)">签字</a>
										<input name="smPermitBy" id="smPermitByName_"
										textName="smPermitByName"
										onbuttonclick="sign_('smPermitByName_','3')"
										allowInput="false" class="mini-buttonedit defSign_" vtype=""
										required="true" />
									</td>
									<td align="right">时间：</td>
									<td><input style="width: 100px;" name="appPermitByTime"
										id="appPermitByTime" class="mini-datepicker" showTime="true"
										vtype="" format="MM-dd" required="false" /></td>
								</tr> -->
								<!-- <tr>
									<td align="right">单元长：</td>
									<td>
										<input name="appUnitLeader" id="appUnitLeaderName_"
										textName="appUnitLeaderName"
										onbuttonclick="sign_('appUnitLeaderName_','')"
										allowInput="false" class="mini-buttonedit defSign_" vtype=""
										required="true" />
									</td>
									<td align="right">时间：</td>
									<td><input style="width: 100px;" allowInput="false"
										name="appUnitLeaderDate" id="appUnitLeaderDate"
										class="mini-datepicker" showTime="true" vtype=""
										format="MM-dd" required="false" /><br /></td>
									<td align="right">值班负责人：</td>
									<td>
										<input name="appDutyPrincipal" id="appDutyPrincipalName_"
										textName="appDutyPrincipalName"
										onbuttonclick="sign_('appDutyPrincipalName_','99')"
										allowInput="false" class="mini-buttonedit defSign_" vtype=""
										required="true" />
									</td>
									<td align="right">时间：</td>
									<td><input style="width: 100px;" allowInput="false"
										name="appDutyPrincipalTime" id="appDutyPrincipalTime"
										class="mini-datepicker" showTime="true" vtype=""
										format="MM-dd" required="false" /></td> -->
								</tr>
								<tr>
								...
								<tr>								   
									...
									<td colspan="3">
										<!-- <input name="workLeaderSignName" id="workLeaderSignName"  class="mini-textbox" vtype = "" allowInput="false"  />
								...
								<tr>
									...
									<td colspan="2">
										<!-- <input name="woWtLC.wtSignerName" id="woWtLC.wtSignerName"  class="mini-textbox" vtype = "" allowInput="false"  />
									...
									<td colspan="2">
										<!-- <input name="woWtLC.permitByName" id="woWtLC.permitByName"  class="mini-textbox" vtype = "" allowInput="false"  />
								...
								<tr>
									...
									<!-- <td align="right">单元长:</td>
									<td colspan="2">										
										<input name="woWtDelay.unitLeader"
										id="woWtDelay.unitLeaderName_"
										textName="woWtDelay.unitLeaderName"
										onbuttonclick="sign_('woWtDelay.unitLeaderName_','99')"
										allowInput="false" class="mini-buttonedit defSign_" vtype=""
										required="true" />
									</td> -->
								...
								<tr>
									...
									<td colspan="2">
										<!-- <input name="endPermitByName" id="endPermitByName"  class="mini-textbox" vtype = "" allowInput="false"  />
							...
							<div class="mini-panel" title="15.检修设备需试运（工作票交回，所列安全措施已拆除，可以试运）："
								...
								<sys:toolbargridsub girdId="gridWoWtBeforeWork"
									permissionEdit="wo:woWtBeforeWork:edit"></sys:toolbargridsub>
							...
							<div class="mini-panel"
								title="16.检修设备试运后仍需要进行检修工作，工作票所列安全措施已全部执行，可以工作：" width="auto"
								id="tabWoWtAfterWorkList" name="tabWoWtAfterWorkList"
								showCollapseButton="true" onbuttonclick="onPanelButtonClick"
								showFooter="true">
								<sys:toolbargridsub girdId="gridWoWtAfterWork"
									permissionEdit="wo:woWtAfterWork:edit"></sys:toolbargridsub>
