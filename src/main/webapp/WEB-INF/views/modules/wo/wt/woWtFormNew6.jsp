				...
				<div id="datagridMain" class="mini-datagrid"
					...
					<div property="columns">
						...
						<div name="content" field="content" vtype=""
							...
							动火工作内容 <input property="editor" class="mini-textbox"
						...
						<div name="status" field="status" vtype="" type="comboboxcolumn"
							...
							状态 <input property="editor" class="mini-combobox"
								...
								url="${ctx}/wo-wt/sys/dict/listDataStr?type=wo_wt_status" /> <input
								id="status-Filter" name="mini-column-filter" property="filter"
								class="mini-combobox" valueField="value" textField="label"
								multiSelect="true"
								url="${ctx}/wo-wt/sys/dict/listDataStr?type=wo_wt_status"
								style="width: 100%;" onvaluechanged="onFilterChanged"
								showClose="true" oncloseclick="onFilterClose(this)" />
						</div>
						...
						<div name="woWtFire.fireMode" field="woWtFire.fireMode" vtype=""
							headerAlign="center" allowSort="true" width="184"
							sortField="wwf.fire_mode" visible="false" hideable="true">
							工作方式 <input property="editor" class="mini-textbox"
								style="width: 100%;" /> <input id="woWtFire.fireMode-Filter"
								name="mini-column-filter" property="filter"
								class="mini-textbox" style="width: 100%;"
								onvaluechanged="onFilterChanged" showClose="true"
								oncloseclick="onFilterClose(this)" />
						...
						<div name="location" field="location" vtype=""
							headerAlign="center" allowSort="true" width="200" visible="false" hideable="true">
						...
						<div name="planStartTime" field="planStartTime" vtype=""
							...
							申请动火时间开始时间 <input property="editor" class="mini-textbox"
						...
						<div name="planEndTime" field="planEndTime" vtype=""
							dateFormat="yyyy-MM-dd HH:mm" headerAlign="center"
							allowSort="true" width="160"  hideable="true">
							申请动火时间结束时间 <input property="editor" class="mini-textbox"
						...
						<!-- <div name="wtReceiveName"  field="wtReceiveName" vtype=""  headerAlign="center" allowSort="true" width="200" >工作票接收人
					...
					<div name="wtReceiveTime"  field="wtReceiveTime" vtype="" dateFormat="yyyy-MM-dd HH:mm" headerAlign="center" allowSort="true" width="160" >工作票接受时间
						<input property="editor" class="mini-textbox"  style="width:100%;"  />
						<input id="wtReceiveTime-Filter" name="mini-column-filter"  property="filter" class="mini-textbox"   style="width:100%;"
							   onvaluechanged="onFilterChanged" showClose="true" oncloseclick="onFilterClose(this)"
						/>
					</div>
					<div name="permitBy"  field="permitBy" vtype=""  headerAlign="center" allowSort="true" width="64" hideable="true" visible="false">工作许可人
						<input property="editor" class="mini-textbox"  style="width:100%;"  />
						<input id="permitBy-Filter" name="mini-column-filter"  property="filter" class="mini-textbox"   style="width:100%;"
							   onvaluechanged="onFilterChanged" showClose="true" oncloseclick="onFilterClose(this)"
						/>
					</div>
					<div name="permitDate"  field="permitDate" vtype="" dateFormat="yyyy-MM-dd HH:mm" headerAlign="center" allowSort="true" width="160" >工作票许可签字时间
						<input property="editor" class="mini-textbox"  style="width:100%;"  />
						<input id="permitDate-Filter" name="mini-column-filter"  property="filter" class="mini-textbox"   style="width:100%;"
							   onvaluechanged="onFilterChanged" showClose="true" oncloseclick="onFilterClose(this)"
						/>
					</div> -->
						...
						<div name="permitByName" field="permitByName" vtype=""
							headerAlign="center" allowSort="true" width="100">
							运行许可人 <input property="editor" class="mini-textbox"
						...
						<div name="permitStartTime" field="permitStartTime" vtype=""
							...
							许可开始工作时间 <input property="editor" class="mini-textbox"
						...
						<div name="woWtFire.endExecByName"
							field="woWtFire.endExecByName" vtype="" headerAlign="center"
							allowSort="true" width="100" sortField="wwf.end_exec_by_name" visible="false" hideable="true">
							动火执行人 <input property="editor" class="mini-textbox"
								style="width: 100%;" /> <input
								id="woWtFire.endExecByName-Filter" name="mini-column-filter"
								property="filter" class="mini-textbox" style="width: 100%;"
								onvaluechanged="onFilterChanged" showClose="true"
								oncloseclick="onFilterClose(this)" />
						</div>
						<div name="woWtFire.endFiremanByName"
							field="woWtFire.endFiremanByName" vtype="" headerAlign="center"
							allowSort="true" width="100"
							sortField="wwf.end_fireman_by_name" visible="false" hideable="true"> 
							消防监护人 <input property="editor" class="mini-textbox"
								style="width: 100%;" /> <input
								id="woWtFire.endFiremanByName-Filter"
								name="mini-column-filter" property="filter"
								class="mini-textbox" style="width: 100%;"
								onvaluechanged="onFilterChanged" showClose="true"
								oncloseclick="onFilterClose(this)" />
						...
						<div name="endWorkLeaderName" field="endWorkLeaderName" vtype=""
							headerAlign="center" allowSort="true" width="100"
							sortField="a.end_work_leader_name" visible="false" hideable="true">
							工作负责人 <input property="editor" class="mini-textbox"
						...
						<div name="woWtFire.endPermitByName"
							field="woWtFire.endPermitByName" vtype="" headerAlign="center"
							allowSort="true" width="100" sortField="wwf.end_permit_by_name" visible="false" hideable="true">
							工作许可人 <input property="editor" class="mini-textbox"
								style="width: 100%;" /> <input
								id="woWtFire.endPermitByName-Filter" name="mini-column-filter"
								property="filter" class="mini-textbox" style="width: 100%;"
								onvaluechanged="onFilterChanged" showClose="true"
								oncloseclick="onFilterClose(this)" />
						</div>
						<div name="woWtFire.workTickets" field="woWtFire.workTickets"
							vtype="" headerAlign="center" allowSort="true" width="64"
							sortField="wwf.work_tickets" visible="false" hideable="true">
							备注 <input property="editor" class="mini-textbox"
								style="width: 100%;" /> <input
								id="woWtFire.workTickets-Filter" name="mini-column-filter"
								property="filter" class="mini-textbox" style="width: 100%;"
								onvaluechanged="onFilterChanged" showClose="true"
								oncloseclick="onFilterClose(this)" />
						</div>
						<div name="remarks" field="remarks" vtype=""
							...
							sortField="a.remarks" visible="false" hideable="true">
							其他事项 <input property="editor" class="mini-textarea"
						...
						<div class="mini-col-12">
							...
							<table class="formtable">
								<tr>
									...
									<td>状态</td>
									<td>
									   <input name="status" id="status" class="mini-combobox" allowInput="false" enabled="false" required="false" valueField="value" textField="label" vtype="" url="${ctx}/ims-ext/sys/dict/listDataStr?type=wo_wt_status" />
									</td>
									<td>专业:</td>
									<td><input name="specId" id="specId" textName="specName" allowInput="false" class="mini-buttonedit" vtype="" required="true" onbuttonclick="selectSpec" /></td>
								</tr>
								<tr>
									<td>所属设备KKS：</td>
									<td>
								...
								<tr>
									...
									<td>
									    <input name="orgId" id="orgId" textName="orgName" allowInput="false" class="mini-buttonedit" width="200px"
									...
									<td ><input name="plantUnit" id="plantUnit" class="mini-combobox"
										...
										url="${ctx}/sys/dict/listDataStr?type=wo_plant_unit" /></td> -->
								</tr>
								<tr>
									<td style="padding-left: 5px;">动火负责人签名：</td>
									<td colspan="5">
									    <input style="width: 150px" name="workLeader" id="workLeader" allowInput="false" required="false" textName="workLeaderName" class="mini-buttonedit" width="200px"
								...
								<tr>
									...
									<td colspan="2">
										<!-- <input name="woWtFire.execByName" id="woWtFire.execByName"  class="mini-textbox" vtype = "" allowInput="false"  />
						                <a class="mini-button"  id="woWtFire.execByName_" name="woWtFire.execByName_" value="99"  onClick="sign(this.name,this.value)">签字</a> -->
										<!-- <input name="woWtFire.execBy" id="woWtFire.execByName_"
										textName="woWtFire.execByName"
										onbuttonclick="sign_('woWtFire.execByName_','99')"
									...
									<td colspan="2"><input name="woWtFire.execByIdNumber" id="woWtFire.execByIdNumber" class="mini-textbox" /></td>
								</tr>
								<tr>
									<td style="padding-left: 5px;">动火执行人签名：</td>
									<td colspan="2">										
									...
									<td align="left">证件编号：</td>
									<td colspan="2"><input name="woWtFire.execByIdNumber2" id="woWtFire.execByIdNumber2" class="mini-textbox" /></td>
								</tr>
								<tr>
									<td>动火地点及设备名称：</td>
									<td colspan="5">
								...
								<tr>
									...
									<td colspan="5"><input name="content" id="content" class="mini-textarea" vtype="" required="false" width="100%" />
									</td>
								</tr>
								<tr>
									<td>动火方式</td>									
									<%-- <td colspan="3">
									    <input name="woWtFire.fireModeId" id="woWtFire.fireModeId" allowInput="true" required="true" class="mini-combobox" valueField="value" textField="label" vtype="" textName="woWtFire.fireMode" url="${ctx}/sys/dict/listDataStr?type=wo_wt_firemode" width="200px"/>
									</td> --%>
									<td colspan="3" >									     
										<div id="woWtFire.fireModeId" name="woWtFire.fireModeId"  class="mini-checkboxlist" repeatItems="6" repeatLayout="table"
								...
								<tr id="sotID">
									...
									<td>许可部门：</td>
									<td colspan="3">
									    <input name="isFuelRun" id="isFuelRun" class="mini-combobox" allowInput="false" enabled="true" required="false" valueField="value" textField="label" vtype="" url="${ctx}/ims-ext/sys/dict/listDataStr?type=wo_is_fuel_run" /></td>
								</tr>								
								<tr>
								    <td>是否风险区域：</td>
									<td colspan="5"><input name="areaName" id="areaName"
									textName="areaName" class="mini-buttonedit" vtype=""
									required="false" allowInput="false" width="40%"
									onbuttonclick="popLov(this,'请选择风险区域',false,true,'${ctx}/em/emRiskArea/list',850,500,'areaName','areaName')" /></td>
								</tr>
								
							</table>
							<div class="mini-panel" title="运行部门应采取的安全措施：" width="auto"
								id="tabWoWtsmList" name="tabWoWtsmList"
								showCollapseButton="true" onbuttonclick="onPanelButtonClick"
								showFooter="true">
								<sys:toolbargridsub girdId="gridWoWtsm"
							...
							<div class="mini-panel" title="动火部门应采取的安全措施" width="auto"
								id="tabWoWtsm6List" name="tabWoWtsm6List"
								showCollapseButton="true" onbuttonclick="onPanelButtonClick"
								showFooter="true">
								<sys:toolbargridsub girdId="gridWoWtsm6"
									permissionEdit="wo:woWt:edit"></sys:toolbargridsub>
								<div id="gridWoWtsm6" class="mini-datagrid sGrid"
									style="width: 99.999%;"
							...
							<table class="formtable">															
								...
								<tr>
									...
									<td colspan="2">
										<!-- <input name="wtSignerName" id="wtSignerName" class="mini-textbox" allowInput="false"/>
								...
								<tr>
									...
									<td colspan="2">
										<!-- <input name="woWtFire.appDeptLeaderName" id="woWtFire.appDeptLeaderName" allowInput="false" class="mini-textbox" vtype = "" allowInput="true"  />
								        <a class="mini-button"  id="woWtFire.appDeptLeaderName_" name="woWtFire.appDeptLeaderName_" value="5" onClick="sign(this.name,this.value)">签字</a> -->
								...
								<tr>
									...
									<td colspan="4">
									            自 <input name="appStartTime" id="appStartTime" class="mini-datepicker" allowInput="false" showTime="true" vtype="" format="yyyy-MM-dd HH:mm:ss" required="false" /> 
										至 <input name="appEndTime" id="appEndTime" class="mini-datepicker" allowInput="false" showTime="true" vtype="" format="yyyy-MM-dd HH:mm:ss" required="false" onvaluechanged="checkEndTime(appStartTime,appEndTime)"/>
									</td>
								</tr>
								<tr>
									<td colspan="6" style="height: 28px;">运行部门应采取的安全措施已全部执行完毕</td>
								</tr>
								<tr>
									<td align="right">运行许可动火时间：</td>
									<td colspan="2">
									    <input name="permitStartTime" id="permitStartTime" class="mini-datepicker" allowInput="false" showTime="true" vtype="" format="yyyy-MM-dd HH:mm:ss" required="false" />
									</td>
									<td align="right">运行许可人签名：</td>
									<td colspan="2">
										<!-- <input name="permitByName" id="permitByName"  class="mini-textbox" vtype = "" allowInput="false"  />
								...
								<!-- <tr>
									<td colspan="4" style="height: 28px;">检修部应采取的安全措施已全部执行完毕</td>
								</tr>-->
								<tr style="display: none;">
									<td align="right">检修负责人签名：</td>
									<td style="text-align: left;"><input
										name="smDutyPrincipal" id="smDutyPrincipalName_"
										textName="smDutyPrincipalName"
										onbuttonclick="sign_('smDutyPrincipalName_','99')"
										allowInput="false" class="mini-buttonedit defSign_" vtype=""
										required="true" /></td>
								</tr> 
								<tr>
									<td colspan="6" style="height: 28px;">应配备的消防设施和采取的消防措施、安全措施已符合要求。可燃性、易爆气体含量或粉尘浓度合格。
									</td>
								</tr>
							</table>
							 <div class="mini-panel" title="可燃性、易爆气体含量或粉尘浓度测定：" width="auto"
								id="tabWoWtMeasureList" name="tabWoWtMeasureList"
								showCollapseButton="false" onbuttonclick="onPanelButtonClick"
								showFooter="true">
								<sys:toolbargridsub girdId="gridWoWtMeasure"
									permissionEdit="wo:woWt:edit"></sys:toolbargridsub>
								<div id="gridWoWtMeasure" class="mini-datagrid sGrid"
									style="width: 99.999%;"
							...
							<table class="formtable">
								...
								<tr>
									...
									<td colspan="2">
										<!-- <input name="woWtFire.safeExecByName" id="woWtFire.safeExecByName"  class="mini-textbox" vtype = "" allowInput="false"  />
								        <a class="mini-button"  id="woWtFire.safeExecByName_" name="woWtFire.safeExecByName_" value="99" onClick="sign(this.name,this.value)">签字</a> -->
										...
										onbuttonclick="popLov(this,'选择人员',false,true,'${ctx}/sys/sysUser/sysMisList?orgQuery=61',850,500,'id,name','woWtFire.safeExecBy,woWtFire.safeExecByName')" onvaluechanged="update(this)" />
									</td>
                                    <td align="right">消防监护人签名：</td>
									<td colspan="2">										
										<input style="width: 180px" name="woWtFire.safeFiremanBy" id="woWtFire.safeFiremanBy" textName="woWtFire.safeFiremanByName" allowInput="false"
										required="false" class="mini-buttonedit" onbuttonclick="popLov(this,'选择人员',false,true,'${ctx}/sys/sysUser/sysMisList',850,500,'id,name','woWtFire.safeFiremanBy,woWtFire.safeFiremanByName')" />
									</td>
									<!-- <td align="right">测定值：</td>
									<td colspan="2"><input name="woWtFire.measuredValue"
										id="woWtFire.measuredValue" class="mini-textbox" vtype=""
										required="false" style="width: 300px;" /></td> -->
								</tr>								
								<tr>
									<%-- <td align="right">动火执行人签名：</td>
									<td colspan="2">
										<!-- <input name="woWtFire.safeExecByName" id="woWtFire.safeExecByName"  class="mini-textbox" vtype = "" allowInput="false"  />
								        <a class="mini-button"  id="woWtFire.safeExecByName_" name="woWtFire.safeExecByName_" value="99" onClick="sign(this.name,this.value)">签字</a> -->
										<input style="width: 180px" name="woWtFire.safeExecByName"
										id="woWtFire.safeExecByName"
										textName="woWtFire.safeExecByName" allowInput="false"
										required="false" class="mini-buttonedit"
										onbuttonclick="popLov(this,'选择人员',false,true,'${ctx}/sys/sysUser/sysMisList?orgQuery=61',850,500,'id,name','woWtFire.safeExecBy,woWtFire.safeExecByName')"
										onvaluechanged="update(this)" />
									</td> --%>
									<td align="right">动火工作负责人签名：</td>
									<td colspan="2">
										<!-- <input name="woWtFire.safeWorkLeaderName" id="woWtFire.safeWorkLeaderName"  class="mini-textbox" vtype = "" allowInput="false"  />
								        <a class="mini-button"  id="woWtFire.safeWorkLeaderName_" name="woWtFire.safeWorkLeaderName_" value="1" onClick="sign(this.name,this.value)">签字</a> -->
										...
										onbuttonclick="popLov(this,'选择人员',false,true,'${ctx}/sys/sysUser/sysMisList?orgQuery=61',850,500,'id,name','woWtFire.safeWorkLeader,woWtFire.safeWorkLeaderName')" onvaluechanged="update(this)" />
									</td>
									<td align="right">动火部门安监人员签名：</td>
									<td colspan="2">
										<!-- <input name="woWtFire.safeDeptSafeByName" id="woWtFire.safeDeptSafeByName"  class="mini-textbox" vtype = "" allowInput="false"  />
								        <a class="mini-button"  id="woWtFire.safeDeptSafeByName_" name="woWtFire.safeDeptSafeByName_" value="4" onClick="sign(this.name,this.value)">签字</a> -->
										...
										onbuttonclick="popLov(this,'选择人员',false,true,'${ctx}/sys/sysUser/sysMisList',850,500,'id,name','woWtFire.safeDeptSafeBy,woWtFire.safeDeptSafeByName')" onvaluechanged="update(this)" />
									</td>
								</tr>
								<tr>
								    <td align="right">消防管理部门负责人：</td>
									<td colspan="2">										
										<input style="width: 180px" name="woWtFire.endsfDeptLeaderName"id="woWtFire.endsfDeptLeaderName" textName="woWtFire.endsfDeptLeaderName" allowInput="false"
										required="false" class="mini-buttonedit" onbuttonclick="popLov(this,'选择人员',false,true,'${ctx}/sys/sysUser/sysMisList',850,500,'id,name','woWtFire.endsfDeptLeader,woWtFire.endsfDeptLeaderName')" />									
									</td>									
									<td align="right">允许动火时间：</td>
									<td colspan="2">
									    <input style="width: 180px" name="woWtFire.safeFireTime" id="woWtFire.safeFireTime" class="mini-datepicker" allowInput="false" showTime="true" vtype="" format="yyyy-MM-dd HH:mm:ss" required="false" /></td>
								</tr>
								<tr>
									<td colspan="6" style="height: 28px;" _emptyName="动火工作全部结束时间">动火结束：动火工作于 
									    <input name="actEndTime" id="actEndTime" class="mini-datepicker" allowInput="false" showTime="true" vtype="" format="yyyy-MM-dd HH:mm:ss" required="false" /> 全部结束。
									</td>
								</tr>
								<tr>
									<td align="right">动火执行人签名：</td>
									<td colspan="2">
										<!-- <input name="woWtFire.endExecByName" id="woWtFire.endExecByName"  class="mini-textbox" vtype = "" allowInput="false"  />
							        	<a class="mini-button"  id="woWtFire.endExecByName_" name="woWtFire.endExecByName_" value="99" onClick="sign(this.name,this.value)">签字</a>  -->
										<!-- <input name="woWtFire.endExecBy" id="woWtFire.endExecByName_"
										textName="woWtFire.endExecByName"
										onbuttonclick="sign_('woWtFire.endExecByName_','99')"
										allowInput="false" class="mini-buttonedit defSign_" vtype=""
										required="true" /> -->
										<input name="woWtFire.endExecByName" id="woWtFire.endExecByName"  class="mini-textbox" vtype = "" allowInput="true"  />
									</td>
									<td align="right">消防监护人签名：</td>
									<td colspan="2">
										<!-- <input name="woWtFire.endFiremanByName" id="woWtFire.endFiremanByName"  class="mini-textbox" vtype = "" allowInput="false"  />
								        <a class="mini-button"  id="woWtFire.endFiremanByName_" name="woWtFire.endFiremanByName_" value="99" onClick="sign(this.name,this.value)">签字</a> -->
								...
								<tr>
									<td align="right">动火工作负责人签名：</td>
									<td colspan="2">
										<!-- <input name="endWorkLeaderName" id="endWorkLeaderName"  class="mini-textbox" vtype = "" allowInput="false"  />
									...
									<td align="right">运行许可人签名：</td>
								    <td colspan="2">
									    <!-- 	<input name="woWtFire.endPermitByName" id="woWtFire.endPermitByName"  class="mini-textbox" vtype = "" allowInput="false"  />
								        <a class="mini-button"  id="woWtFire.endPermitByName_" name="woWtFire.endPermitByName_" value="3" onClick="sign(this.name,this.value)">签字</a> -->
										<!-- <input name="woWtFire.endPermitBy" id="woWtFire.endPermitByName_" textName="woWtFire.endPermitByName"
										onbuttonclick="sign_('woWtFire.endPermitByName_','3')" allowInput="false" class="mini-buttonedit defSign_" vtype="" required="true" /> -->
									...
									<!-- <td colspan="2"> <input name="woWtFire.endPermitByName"
										id="woWtFire.endPermitByName_" class="mini-textbox" vtype=""
								...
								<!-- <tr>
							<td >13．备注：</td>
							<td colspan="5">（1）对应的检修工作票、工作任务单或事故抢修单编号（如无，填写“无”）：
								<input style="width:10%;" name="woWtFire.workTickets" id="woWtFire.workTickets" class="mini-textbox"  vtype = ""  required="false" width="100%" />
							</td>
						</tr> -->
								<tr>
									<td>
