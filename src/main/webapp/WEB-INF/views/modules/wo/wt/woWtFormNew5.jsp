		...
		<div title="列表" id="tabList" style="border: 0px;">
			...
			<div class="mini-fit">
				<div id="datagridMain" class="mini-datagrid"
					style="width: 100%; height: 100%;"
					url="${ctx}/wo/woWt/data?baseQuery=a.is_standard=${isStandard}"
					...
					<div property="columns">
						...
						<div name="woWtFire.fireMode" field="woWtFire.fireMode" vtype=""
							...
							sortField="wwf.fire_mode" hideable="true" visible="false">
						...
						<div name="wtSignDate" field="wtSignDate" vtype=""
							dateFormat="yyyy-MM-dd HH:mm" headerAlign="center"
							allowSort="true" width="160" hideable="true" visible="false">
						...
						<div class="mini-col-12">
							...
							<table class="formtable">
								...
								<tr>
									...
									<td >
									    <input name="orgId" id="orgId" textName="orgName" required="true" class="mini-buttonedit" width="200px"
									...
									<td>班组：</td>
									<td >
									    <input name="maintOrg" id="maintOrg" textName="maintOrgName" class="mini-buttonedit" vtype=""
								...
								<tr>
									...
									<td colspan="3"><input name="woWtFire.execByIdNumber" id="woWtFire.execByIdNumber" class="mini-textbox" /></td>
								</tr>
								<tr>
									<td style="padding-left: 5px;">动火执行人签名：</td>
									<td>										
									...
									<td align="left">证件编号：</td>
									<td colspan="3"><input name="woWtFire.execByIdNumber2" id="woWtFire.execByIdNumber2" class="mini-textbox" /></td>
								</tr>
								<tr>
									<td>动火地点及设备名称：</td>
									<td colspan="5">
								...
								<tr>
									...
									<td colspan="5"><input name="content" id="content" class="mini-textarea" vtype="" required="false" width="100%" /></td>
								</tr>
								<tr>
									<td>动火方式</td>									
									<%-- <td colspan="3">
									    <input name="woWtFire.fireModeId" id="woWtFire.fireModeId" allowInput="true" required="true" class="mini-combobox" width="200px"
										valueField="value" textField="label" vtype="" textName="woWtFire.fireMode" url="${ctx}/sys/dict/listDataStr?type=wo_wt_firemode" />
									</td>	 --%>
									<td colspan="3" >									     
								...
								<div id="gridWoWtsm" class="mini-datagrid sGrid"
									...
									<div property="columns">
										...
										<!-- <div name="execRes" field="execRes" vtype=""
											...
											width="200">
											执行情况<input property="editor" class="mini-textarea" style="width: 100%;" />
										</div> -->
									</div>
								</div>
							</div>
							...
							<table class="formtable">
								...
								<tr>
									<!-- <td align="right">动火部门负责人：</td>
									<td>										
										<input name="woWtFire.appCompLeader"
										id="woWtFire.appCompLeaderName_"
										textName="woWtFire.appCompLeaderName"
										onbuttonclick="sign_('woWtFire.appCompLeaderName_','99')"
								...
								<tr>
									...
									<td style="text-align: left;">										
										<input name="woWtFire.appCompProcLeader" id="woWtFire.appCompProcLeaderName_" textName="woWtFire.appCompProcLeaderName"
										 onbuttonclick="sign_('woWtFire.appCompProcLeaderName_','99')" allowInput="false" class="mini-buttonedit defSign_" vtype="" required="true" />
									</td>
							 ...
							 <table class="formtable">
								...
								<tr>
									...
									<td colspan="2">										
										<input style="width: 180px" name="woWtFire.safeDeptLeaderName" id="woWtFire.safeDeptLeaderName" textName="woWtFire.safeDeptLeaderName" allowInput="false"
										 required="false" class="mini-buttonedit" onbuttonclick="popLov(this,'选择人员',false,true,'${ctx}/sys/sysUser/sysMisList',850,500,'id,name','woWtFire.safeDeptLeader,woWtFire.safeDeptLeaderName')" />										
									</td>
								</tr>
								<tr>
								    <td align="right">消防管理部门负责人：</td>
									...
									<td align="right">安健环部负责人：</td>
									<td colspan="2">										
										<input style="width: 180px" name="woWtFire.safeCompSafeHealthName" id="woWtFire.safeCompSafeHealthName" textName="woWtFire.safeCompSafeHealthName" allowInput="false"
										required="false" class="mini-buttonedit" onbuttonclick="popLov(this,'选择人员',false,true,'${ctx}/sys/sysUser/sysMisList?baseFilter=a.org_id=1963',850,500,'id,name','woWtFire.safeCompSafeHealth,woWtFire.safeCompSafeHealthName')" />										
									</td>									
								</tr>
								<tr>
								    <td align="right">公司领导：</td>
									<td colspan="2">										
										<input style="width: 180px" name="woWtFire.safeCompProcLeaderName" id="woWtFire.safeCompProcLeaderName" textName="woWtFire.safeCompProcLeaderName" allowInput="false"
										 required="false" class="mini-buttonedit" onbuttonclick="popLov(this,'选择人员',false,true,'${ctx}/sys/sysUser/sysMisList?baseFilter=a.org_id=1956',850,500,'id,name','woWtFire.safeCompProcLeader,woWtFire.safeCompProcLeaderName')" />										
									</td>
									<td align="right">允许动火时间：</td>
									<td colspan="2">
									    <input name="woWtFire.safeFireTime" id="woWtFire.safeFireTime" class="mini-datepicker"
										 showTime="true" vtype="" format="yyyy-MM-dd HH:mm:ss" required="false" />
									</td>																
								</tr>
								<tr>
								...
								<tr>
									<td align="right">动火执行人签名：</td>
									<td colspan="2">										
										<!-- <input name="woWtFire.endExecBy" id="woWtFire.endExecByName_" textName="woWtFire.endExecByName"
										onbuttonclick="sign_('woWtFire.endExecByName_','99')" allowInput="false" class="mini-buttonedit defSign_" vtype="" required="true" /> -->
										<input name="woWtFire.endExecByName" id="woWtFire.endExecByName" class="mini-textbox" allowInput="true"/>
									</td>
									<td align="right">消防监护人签名：</td>
									<td colspan="2">
										<!-- <input name="woWtFire.endFiremanByName" id="woWtFire.endFiremanByName" class="mini-textbox" allowInput="true"/>
								...
								<tr>
									<td align="right">动火工作负责人签名：</td>
									<td colspan="2">
										<!-- <input name="endWorkLeaderName" id="endWorkLeaderName" class="mini-textbox" allowInput="true"/>
