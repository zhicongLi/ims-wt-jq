...
<body>
				...
				<div id="datagridMain" class="mini-datagrid"
					...
					<div property="columns">
						...
						<div name="status" field="status" vtype="" type="comboboxcolumn"
							headerAlign="center" allowSort="false" width="80"
							sortField="a.status">
						...
						<%-- <div name="specId"  field="specId" vtype="" align="center" headerAlign="center" type="comboboxcolumn"  allowSort="true" width="80" >专业
							<input property="editor" class="mini-combobox"  valueField="id" textField="name" url="${ctx}/ims-ext/pg/pgSpec/dictData?groupId=3"   style="width:100%;"  />
							<input id="specId-Filter" name="mini-column-filter"  property="filter" class="mini-combobox" multiSelect="true" valueField="id" textField="name"  url="${ctx}/ims-ext/pg/pgSpec/dictData?groupId=3"  style="width:100%;"
						...
						<div name="workCondition.descr" field="workCondition.descr"
							vtype="" headerAlign="center" allowSort="true" width="200"
							sortField="wws9.descr" visible="false" hideable="true">
							工作条件 <input property="editor" class="mini-textbox"
								style="width: 100%;" /> <input
								id="workCondition.descr-Filter" name="mini-column-filter"
								property="filter" class="mini-textbox" style="width: 100%;"
								onvaluechanged="onFilterChanged" showClose="true"
								oncloseclick="onFilterClose(this)" />
						</div>
						<div name="safeMeasure.descr" field="safeMeasure.descr" vtype=""
							headerAlign="center" allowSort="true" width="200"
							sortField="wws5.descr" visible="false" hideable="true">
							注意事项 <input property="editor" class="mini-textbox"
								style="width: 100%;" /> <input id="safeMeasure.descr-Filter"
								name="mini-column-filter" property="filter"
								class="mini-textbox" style="width: 100%;"
								onvaluechanged="onFilterChanged" showClose="true"
								oncloseclick="onFilterClose(this)" />
						...
						<div name="wtReceiveName" field="wtReceiveName" vtype=""
							headerAlign="center" allowSort="true" width="140" hideable="true" visible="false">
							工作票接收人 <input property="editor" class="mini-textbox"
						...
						<div name="wtReceiveTime" field="wtReceiveTime" vtype=""
							dateFormat="yyyy-MM-dd HH:mm:ss" headerAlign="center"
							allowSort="true" width="100" hideable="true" visible="false">
							工作票接受时间 <input property="editor" class="mini-textbox"
						...
						<div name="endWorkLeaderName" field="endWorkLeaderName" vtype=""
							headerAlign="center" allowSort="true" width="100" visible="false" hideable="true">
							工作负责人 <input property="editor" class="mini-textbox"
				...
				<div class="container" style="width: 100%;">
					<div class="mini-clearfix ">
						<div class="mini-col-12">
							...
							<input class="mini-hidden" name="orgName" id="orgName" /> <input
								class="mini-hidden" name="pcSigner" id="pcSigner" /> <input
								class="mini-hidden" name="workCondition.id"
								id="workCondition.id" /> <input class="mini-hidden"
								name="workCondition.wtId" id="workCondition.wtId" /> <input
								class="mini-hidden" name="workCondition.typeId"
								id="workCondition.typeId" /> <input
								class="mini-hidden" name="safeMeasure.id" id="safeMeasure.id" />
							<input class="mini-hidden" name="safeMeasure.wtId"
								id="safeMeasure.wtId" /> <input class="mini-hidden"
								name="safeMeasure.typeId" id="safeMeasure.typeId" /> <!-- <input
								class="mini-hidden" name="safeMeasure.descr"
								id="safeMeasure.descr" /> --> <input class="mini-hidden"
								name="specShortCode" id="specShortCode" /> <input
								class="mini-hidden" name="defectId" id="defectId"
								value="${defectId}" /> <input class="mini-hidden"
								id="isStandard" name="isStandard" value="${param.isStandard }">

							<input class="mini-hidden" name="procStatus" id="procStatus" />
							<input class="mini-hidden" id="currUserName" name="currUserName"
								value="${param.currUserName}"> <input class="mini-hidden"
								id="currUserId" name="currUserId" value="${param.currUserId}">
							<input type="hidden" id="currUserLoginName"
								name="currUserLoginName" value="${param.currUserLoginName}"> <input
								class="mini-hidden" id="dutyOrgId" name="dutyOrgId">
							...
							<table class="formtable">
								<tr>
									...
									<td><input name="wtCode" id="wtCode" class="mini-textbox" width="200px"
									...
									<td><input name="specId" id="specId" textName="specName"
										class="mini-buttonedit" vtype="" required="true" allowInput="false" 
								...
								<tr>
									...
									<td><input name="orgId" id="orgId" textName="orgName"
										...
										onbuttonclick="popLov(this,'选择部门',false,true,'${ctx}/ims-ext/sys/sysOrg/list?classId=0',850,500,'id,name','orgId,orgName')"
										onvaluechanged="changeDutyOrg"></td>
									<td>班组：</td>
									<td><input name="maintOrg" id="maintOrg"
										textName="maintOrgName" class="mini-buttonedit" vtype=""
										required="true" width="150px" allowInput="false"
									...
									<td><input style="width: 150px" name="workLeader"
										id="workLeader" required="true" textName="workLeaderName"
										class="mini-buttonedit"
										onbuttonclick="popLov(this,'选择人员',false,true,'${ctx}/ims-ext/sys/sysUser/sysMisList?orgQuery=61',850,500,'id,name','workLeader,workLeaderName')"
										onvaluechanged="update(this)" /></td>
								</tr>
								<tr>
									<td>所属设备KKS：</td>
									<td><input name="equipLogicId" id="equipLogicId"
										textName="equipLogicId" allowInput="true" width="200px"
										class="mini-buttonedit" vtype="" required="false"
										onbuttonclick="popLov(this,'选择逻辑设备',false,true,'${ctx}/ims-ext/em/emEquipLogic/lov',800,500,'id,name','equipLogicId,equipLogicName',null,null,selectKKS)"
								...
								<tr>
									<td>2.工作内容：</td>
									<td colspan="5"><input name="content" id="content"
								...
								<tr>
									...
									<td colspan="3"><input name="location" id="location"
										...
										onbuttonclick="popLov(this,'选择工作地址',false,true, '${ctx}/ims-ext/em/emEquipLogic/lov2'
								...
								<tr>
									...
									<td><input name="planStartTime" allowInput="false"
										id="planStartTime" class="mini-datepicker" showTime="true"
										vtype="" format="yyyy-MM-dd HH:mm:ss" required="false"
										style="width: 180px;" /></td>
									<td align="right">结束时间：</td>
									<td colspan="2"><input name="planEndTime"
										allowInput="false" id="planEndTime" class="mini-datepicker"
										showTime="true" vtype="" format="yyyy-MM-dd HH:mm:ss"
										required="false" style="width: 180px;" onvaluechanged="checkEndTime(planStartTime,planEndTime)"/></td>
								</tr>
								<tr>
									<td>5. 工作条件（停电或不停电，或<br />邻近及保留带电设备名称）：
									</td>
									<td colspan="5"><input name="workCondition.descr"
										id="workCondition.descr" class="mini-textarea" vtype=""
										required="false" width="100%" /></td>
								</tr>
								<tr>
									<td>6.安全措施<br />（注意事项）：
									</td>
									<td colspan="5"><input name="safeMeasure.descr"
										id="safeMeasure.descr" class="mini-textarea" vtype=""
										required="false" width="100%" height="150px" /></td>
								</tr>
								...
								<tr id="sotID">										
									...
									onbuttonclick="popLov(this,'请选择风险区域',false,true,'${ctx}/ims-ext/em/emRiskArea/list',850,500,'areaName','areaName')" /></td>	
								</tr>
							...
							<table class="formtable">
								...
								<tr>
									<td>工作票接收人签名：</td>
									<td colspan="2"><input name="wtReceiver" id="wtReceiveName_"
										textName="wtReceiveName"
										onbuttonclick="sign_('wtReceiveName_','99')"
										allowInput="false" class="mini-buttonedit defSign_" vtype=""
										required="false" /> <!-- <a class="mini-button"  id=wtReceiveName_ name="wtReceiveName_" value="99" onClick="sign(this.name,this.value)">签字</a> -->
									</td>
									<td>收到工作票时间：</td>
							...
							<div class="mini-panel" title="补充安全措施" width="auto"
							...
							<table class="formtable">
								<tr>
									...
									<td><input name="permitStartTime" id="permitStartTime"
										class="mini-datepicker" showTime="true" vtype=""
										format="yyyy-MM-dd HH:mm:ss" allowInput="false"
										style="width: 180px;" /></td>
									<td style="text-align: left;">工作负责人签名:</td>
									<td><input name="workLeaderSign" id="workLeaderSignName_"
										textName="workLeaderSignName"
										onbuttonclick="sign_('workLeaderSignName_','1')"
										allowInput="false" class="mini-buttonedit defSign_" vtype=""
										required="false" /> <!-- <a class="mini-button" id="workLeaderSignName_"  name="workLeaderSignName_" value="1" onClick="sign(this.name,this.value)">签字</a>  -->
									</td>	
									<td style="text-align: left;">工作许可人（值班员）签名：</td>
									<td colspan="1"><input name="permitBy" id="permitByName_"
										textName="permitByName" onvaluechanged="padWorkLeader"
								...
								<tr>
									<td colspan="6" style="height: 28px;">8.工作票延期：有效期延期到 <input
								...
								<tr>
									<td></td>
									<td colspan="2">工作许可人： <input
										name="woWtDelay.permitBy" id="woWtDelay.permitByName_"
										textName="woWtDelay.permitByName"
										onbuttonclick="sign_('woWtDelay.permitByName_','3')"
										allowInput="false" class="mini-buttonedit defSign_" vtype=""
									...
									<td >签字时间： <input name="woWtDelay.permitByTime"
										id="woWtDelay.permitByTime" class="mini-datepicker" showTime="true"
										vtype="" allowInput="false" format="yyyy-MM-dd HH:mm:ss"
										required="false" />
									</td>
									<td colspan="2"></td>
								...
								<tr>
									<td colspan="6" style="height: 28px;" _emptyName="全部工作结束时间">9.全部工作于：<input name="actEndTime" id="actEndTime"
										class="mini-datepicker" allowInput="false" showTime="true"
										vtype="" format="yyyy-MM-dd HH:mm:ss" required="false"
										style="width: 180px;" />结束，工作班人员已全部撤离，现场已清理完毕</td>
									<!-- <td > <input name="endPermitBy"
								...
								<tr>
									<td></td>
									<td style="text-align: left;">工作负责人签名:</td>
									<td colspan="2"><input name="endWorkLeader" id="endWorkLeaderName_"
										textName="endWorkLeaderName"
										onbuttonclick="sign_('endWorkLeaderName_','1')"
										allowInput="false" class="mini-buttonedit defSign_" vtype=""
										required="false" /> <!--  <a id="endWorkLeaderName_" class="mini-button" name="endWorkLeaderName_" value="1" onClick="sign(this.name,this.value)">签字</a> -->
									</td>
									<td style="text-align: left;">工作许可人签名：</td>
									<td colspan="2"><!-- <input name="endPermitByName" id="endPermitByName"
										class="mini-textbox"> --> <input name="endPermitBy" id="endPermitByName_" textName="endPermitByName" onbuttonclick="sign_('endPermitByName_','3')" allowInput="false"  class="mini-buttonedit defSign_" vtype = "" required="false" />	
										<!-- <a id="endPermitByName_" class="mini-button" name="endPermitByName_" value="3" onClick="sign(this.name,this.value)">签字</a> -->
									</td>
								</tr>
								<!-- <tr>
									<td>10.工作组成员安全交底签名：</td>
	...
	<script type="text/javascript">
		initBase({
			...
			onBeforeFlowAction : flowAction,		
			onAfterFlowAction:closeLinkDefect */
		});
