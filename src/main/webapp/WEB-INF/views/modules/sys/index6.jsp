...
<meta charset="utf-8">
 ...
 <link rel="stylesheet" href="${ctxStatic}/daping4/index.css"/>
</head>
<body>
<div id="fileInput">
<input type="file" id="file" onchange="setVideoSrc()">
			...
			<div id="main" class="main main-section">
				...
				<aside class="parameter-area">
					<div class="parameter-wrap">
						...
						<div class="parameter-list param-outside">
							<h3>外来人员统计</h3>
							<div class="visitors">
								<p>外委人员(<span class="visitors_member" id="delegateNum">-1</span>)人</p>
								<p>访客人员(<span class="visitors_member" id="visitNum">-1</span>)人</p>
							</div>
						</div>
					</div>
				</aside>
	...
	<script type="text/javascript">
			...
			try{
				$.ajax({
		           ...
		           // 	alert(typeof d);
		            	if(d.type=='I'){
		            		var p = d.data;
		            		var visitNum = p.visitNum;
		            		var delegateNum = p.delegateNum;
		            		if(visitNum){
		...
		setInterval(getPerson,1000*60*10);//获取外委人员，10分钟更新一次
