...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			var data = ${fns:toJson(list)}, rootId = "${not empty org.id ? org.id : '0'}";
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/sys/org/list?id=${org.id}&parentIds=${org.parentIds}">机构列表</a></li>
		<shiro:hasPermission name="sys:org:edit"><li><a href="${ctx}/sys/org/form?parent.id=${org.id}">机构添加</a></li></shiro:hasPermission>
	</ul>
