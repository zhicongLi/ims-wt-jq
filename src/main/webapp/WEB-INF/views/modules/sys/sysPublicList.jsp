...
<body>
	   <sys:toolbargridsingle objId="SysPublic"  permissionEdit="sys:sysPublic:edit"></sys:toolbargridsingle>
		...
		>
			<div property="columns">
				...
				<div type="checkcolumn"></div>
					...
					<div name="siteId" field="siteId" vtype="" readOnly="true"  headerAlign="center" allowSort="true" width="64" >域编码
						<input property="editor" class="mini-textbox"  style="width:100%;"  />
