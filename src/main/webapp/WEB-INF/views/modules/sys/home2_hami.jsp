                        ...
                        <div class="box-header with-border">
							...
							<div id="myTabContent" class="tab-content">
							    <div class="tab-pane fade in active" id="bulletin">
									<act:todoTask tbodyId="daiban" title="缺陷待办" isToDo="1" procDefKey="flow_spot_check" url="${ctx}/wo/woDefect/todoTask" needVar="0" pageSize="5"  func="loadPageData"></act:todoTask>
							    ...
							    <div class="tab-pane fade" id="rule">
							    	...
							    	<act:todoTask tbodyId="yiban" title="缺陷已办" isToDo="0" procDefKey="flow_spot_check" url="${ctx}/wo/woDefect/historicTask" needVar="0" pageSize="5"  func="loadPageData"></act:todoTask>
...
<div class="row">
           ...
           // 	fetchCmsArticle(); //获取定期工作
            ...
            function onDaiBan(){//点击待办时
            	wzToDoTask();//加载物资待办
            	notice();//加载知会
            	toLoadTask("daiban","${ctx}/wo/woDefect/todoTask",{procDefKey:'flow_spot_check',pageSize:'5',needVar:"0"},'1');
            ...
            function onYiBan(){//点击已办时
            	toLoadTask("yiban","${ctx}/wo/woDefect/historicTask",{procDefKey:'flow_spot_check',pageSize:'5',needVar:"0"},'0');
            	 ...
            	 if(divId=='main3'){
            		...
            		var plantUnit = "";
            		 ...
            		 if(countByDept){
            			 ...
            			 url="${ctx}/wo/woDefect/form?plantUnit="+plantUnit+"&dataFilter=(a.status!=12 and final_wc.receive_dept is null)";
            		 }
            		 if(seriesIndex==1){//挂起
            			url+="&status=8";
            		 }
