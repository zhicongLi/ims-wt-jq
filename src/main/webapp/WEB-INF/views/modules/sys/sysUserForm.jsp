												...
												<table border="0" cellpadding="3" cellspacing="3">
													...
													<tr>
														...
														<td><input name="loginIp" id="loginIp"
															class="mini-textbox" vtype="" required="false" /></td>
														<td style="text-align: right;">测试用户：</td>
														<td><input name="userId2" id="userId2" textName="userId2" class="mini-buttonedit" vtype = "" onbuttonclick="popLov(this,'选择用户',false,true,'${ctx}/sys/sysUser/sysMisList?type=defect',1200,600,'id,name','userId2,userName2',null,null,null,null,'datagridMain','datagridOften',true,null,null,'selectedUserId,selectedUserName')"  required="false" />
														    <input name="userId" id="userId" textName="userName" class="mini-buttonedit" vtype = "" onbuttonclick="popLovJson(this)"  required="false" /> 
														</td>
													</tr>
