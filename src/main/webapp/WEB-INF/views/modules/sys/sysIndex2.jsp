...
<%--<jsp:include flush="true" page="/WEB-INF/views/include/taglib.jsp"/>--%>
<%--<jsp:include flush="true" page="/WEB-INF/views/include/head.jsp"/>--%>
<html>
<head>
	...
	<link href="${ctxStatic}/templates/2/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet" type="text/css" />
	...
	<link href="${ctxStatic}/templates/2/assets/css/themes/layout/aside/dark.css" rel="stylesheet" type="text/css" />
	<!--end::Layout Themes-->
			...
			buildChildren(parent,rootId,subMenu,topMenu) {
				...
				if(subMenu){
					...
					if(topMenu==true){
						...
						$div = $(' <div class="menu-submenu menu-submenu-classic menu-submenu-right" >');
					}
...
<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
	<!--begin::Logo-->
	<a href="javascript:;">
		<img alt="Logo" src="${ctxStatic}/images/logo-light-s.png" />
	</a>
	<!--end::Logo-->
	<!--begin::Toolbar-->
...
<div class="d-flex flex-column flex-root">
	...
	<div class="d-flex flex-row flex-column-fluid page">
		...
		<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
			...
			<div class="brand flex-column-auto" id="kt_brand">
				...
				<a href="javascript:;" class="brand-logo">
					<img alt="Logo" src="${ctxStatic}/images/logo-light-m.png" />
				</a>
				<!--end::Logo-->
				<!--begin::Toggle-->
			...
			<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
				...
				<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
					<!--begin::Menu Nav-->
					<ul class="menu-nav" id="_leftMenu">
						<%--						<li class="menu-section">--%>
						<%--&lt;%&ndash;							<h4 class="menu-text">电力交易</h4>&ndash;%&gt;--%>
		...
		<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
				...
				<div class="container-fluid d-flex align-items-stretch justify-content-between">
							...
							<ul class="menu-nav">
								<li class="menu-item menu-item-open menu-item-here menu-item-submenu menu-item-rel menu-item-open menu-item-here menu-item-active" data-menu-toggle="click" aria-haspopup="true">
									...
									<div class="menu-submenu menu-submenu-classic menu-submenu-left">
										<ul class="menu-subnav" id="_topMenu">
											...
											<ul class="menu-content">
													...
													<ul class="menu-inner">
														<li class="menu-item" aria-haspopup="true">
															<a href="javascript:;" class="menu-link">
																...
																<span class="menu-text">三外管理</span>
															</a>
														</li>
														<li class="menu-item" aria-haspopup="true">
															<a href="javascript:;" class="menu-link">
														...
														<li class="menu-item" aria-haspopup="true">
															<a href="javascript:;" class="menu-link">
																...
																<span class="menu-text">教育培训</span>
															</a>
														</li>
														<li class="menu-item" aria-haspopup="true">
															<a href="javascript:;" class="menu-link">
																...
																<span class="menu-text">安全分析</span>
															</a>
														</li>
														<li class="menu-item" aria-haspopup="true">
															<a href="javascript:;" class="menu-link">
																...
																<span class="menu-text">二十五项反措</span>
															</a>
														</li>
													</ul>
												</li>
												<li class="menu-item">
													<h3 class="menu-heading menu-toggle">
														...
														<span class="menu-text">燃料管理</span>
														<i class="menu-arrow"></i>
													</h3>
													<ul class="menu-inner">
														<li class="menu-item" aria-haspopup="true">
														...
														<li class="menu-item" aria-haspopup="true">
															<a href="javascript:;" class="menu-link">
																...
																<span class="menu-text">3D煤仓</span>
															</a>
														</li>
														<li class="menu-item" aria-haspopup="true">
															<a href="javascript:;" class="menu-link">
																...
																<span class="menu-text">实时预警</span>
															</a>
														</li>
														<li class="menu-item" aria-haspopup="true">
															<a href="javascript:;" class="menu-link">
												...
												<li class="menu-item">
													<h3 class="menu-heading menu-toggle">
														...
														<span class="menu-text">供热固弃物</span>
														<i class="menu-arrow"></i>
													</h3>
													<ul class="menu-inner">
														<li class="menu-item" aria-haspopup="true">
														...
														<li class="menu-item" aria-haspopup="true">
															<a href="javascript:;" class="menu-link">
																...
																<span class="menu-text">网上营业厅</span>
															</a>
														</li>
														<li class="menu-item" aria-haspopup="true">
															<a href="javascript:;" class="menu-link">
																...
																<span class="menu-text">计量管理</span>
															</a>
														</li>
														<li class="menu-item" aria-haspopup="true">
															<a href="javascript:;" class="menu-link">
								...
								<li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click" aria-haspopup="true">
									<a href="javascript:;" class="menu-link menu-toggle">
										<span class="menu-text">快捷操作</span>
										<i class="menu-arrow"></i>
									</a>
									<div class="menu-submenu menu-submenu-classic menu-submenu-left">
					...
					<div class="topbar">
						...
						<div class="dropdown">
							...
							<div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
								<div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
									<img class="h-50px w-50px rounded-circle" src="${ctxStatic}/templates/2/assets/media/users/default.jpg" alt="" />
								</div>
							</div>
							<!--end::Toggle-->
							<!--begin::Dropdown-->
							<div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
								...
								<ul class="navi navi-hover py-4">
									...
									<li class="navi-item">
										<a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="${ctxStatic}/templates/2/assets/media/svg/flags/226-united-states.svg" alt="" />
													</span>
									...
									<li class="navi-item active">
										<a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="${ctxStatic}/templates/2/assets/media/svg/flags/128-spain.svg" alt="" />
													</span>
									...
									<li class="navi-item">
										<a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="${ctxStatic}/templates/2/assets/media/svg/flags/162-germany.svg" alt="" />
													</span>
									...
									<li class="navi-item">
										<a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="${ctxStatic}/templates/2/assets/media/svg/flags/063-japan.svg" alt="" />
													</span>
									...
									<li class="navi-item">
										<a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="${ctxStatic}/templates/2/assets/media/svg/flags/195-france.svg" alt="" />
													</span>
						...
						<div class="topbar-item">
							<div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
								...
								<span class="text-gray  font-weight-bolder font-size-base d-none d-md-inline mr-3">${fns:getUser().name}</span>
			...
			<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
				...
				<div class="d-flex flex-column-fluid">
					...
					<div class="container">
						...
						<!--begin::Row-->
						<div class="row">
							<div id="_mainTabs" class="mini-tabs" activeIndex="0" style="width:100%;height:750px;"
								 plain="false" onactivechanged="onTabsActiveChanged" onbeforecloseclick="onTabsBeforeClose"  contextMenu="#_tabsMenu"
							>
								<div title="首页" id="_tabHome" name="_tabHome" url="form?view=rp/rpTestReport" iconCls="fa fa-home" >
								</div>
							</div>
						</div>
					</div>
			...
			<%--						<a href="http://keenthemes.com/metronic" target="_blank" class="text-dark-75 text-hover-primary">智慧江苏项目组</a>--%>
			<%--					</div>--%>
			<%--					<!--end::Copyright-->--%>
			<%--					<!--begin::Nav-->--%>
			<%--					<div class="nav nav-dark">--%>
			<%--						<a href="http://keenthemes.com/metronic" target="_blank" class="nav-link pl-0 pr-5">关于</a>--%>
			<%--						<a href="http://keenthemes.com/metronic" target="_blank" class="nav-link pl-0 pr-5">团队</a>--%>
			<%--						<a href="http://keenthemes.com/metronic" target="_blank" class="nav-link pl-0 pr-0">联系</a>--%>
			<%--					</div>--%>
			<%--					<!--end::Nav-->--%>
			<%--				</div>--%>
			<%--				<!--end::Container-->--%>
...
<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
	...
	<div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
		<h3 class="font-weight-bold m-0">个人信息
			<small class="text-muted font-size-sm ml-2">12 条消息</small></h3>
	...
	<div class="offcanvas-content pr-5 mr-n5">
		...
		<div class="d-flex align-items-center mt-5">
			<div class="symbol symbol-100 mr-5">
				<%--				<div class="symbol-label" style="background-image:url('${ctxStatic}/templates/2/assets/media/users/300_21.jpg')"></div>--%>
				<i class="symbol-badge bg-success"></i>
			</div>
			<div class="d-flex flex-column">
				<a href="javascript:openUserInfo();" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">${fns:getUser().name}</a>
		...
		<a href="javascript:modifyUserPassword();" class="text-center bg-hover-light border-right" >
			修改密码
		</a>
		<a href="/logout" class="text-center bg-hover-light border-right" style="color:red">
			退出
		</a>
		<!--end::Separator-->
		<!--begin::Nav-->
		<div class="navi navi-spacer-x-0 p-0">
			...
			<a href="custom/apps/user/profile-1/personal-information.html" class="navi-item">
				<div class="navi-link">
					...
					<div class="navi-text">
						<div class="font-weight-bold">我的信息</div>
						<div class="text-muted">账号信息设置
							<span class="label label-light-danger label-inline font-weight-bold">更新</span></div>
					</div>
				</div>
			</a>
			<!--end:Item-->
			...
			<a href="custom/apps/user/profile-3.html" class="navi-item">
				<div class="navi-link">
					...
					<div class="navi-text">
						<div class="font-weight-bold">我的消息</div>
						<div class="text-muted">待办任务和收件箱</div>
					</div>
				</div>
			</a>
			<!--end:Item-->
			...
			<a href="custom/apps/user/profile-2.html" class="navi-item">
				<div class="navi-link">
					...
					<div class="navi-text">
						<div class="font-weight-bold">我的活动</div>
						<div class="text-muted">日志和通知</div>
					</div>
				</div>
			</a>
			<!--end:Item-->
			...
			<a href="custom/apps/userprofile-1/overview.html" class="navi-item">
				<div class="navi-link">
					...
					<div class="navi-text">
						<div class="font-weight-bold">我的任务</div>
						<div class="text-muted">最新任务和项目</div>
					</div>
				</div>
			</a>
			<!--end:Item-->
...
<div id="kt_quick_panel" class="offcanvas offcanvas-right pt-5 pb-10">
	...
	<div class="offcanvas-header offcanvas-header-navs d-flex align-items-center justify-content-between mb-5">
		<ul class="nav nav-bold nav-tabs nav-tabs-line nav-tabs-line-3x nav-tabs-primary flex-grow-1 px-10" role="tablist">
			<li class="nav-item">
				<a class="nav-link active" data-toggle="tab" href="#kt_quick_panel_logs">日志</a>
			</li>
			<li class="nav-item">
				<a class="nav-link" data-toggle="tab" href="#kt_quick_panel_notifications">通知</a>
			</li>
			<li class="nav-item">
				<a class="nav-link" data-toggle="tab" href="#kt_quick_panel_settings">设置</a>
			</li>
		</ul>
				...
				<div class="mb-15">
					...
					<div class="d-flex align-items-center flex-wrap mb-5">
						<div class="symbol symbol-50 symbol-light mr-5">
									<span class="symbol-label">
										<img src="${ctxStatic}/templates/2/assets/media/svg/misc/006-plurk.svg" class="h-50 align-self-center" alt="" />
									</span>
						</div>
						<div class="d-flex flex-column flex-grow-1 mr-2">
					...
					<div class="d-flex align-items-center flex-wrap mb-5">
						<div class="symbol symbol-50 symbol-light mr-5">
									<span class="symbol-label">
										<img src="${ctxStatic}/templates/2/assets/media/svg/misc/015-telegram.svg" class="h-50 align-self-center" alt="" />
									</span>
						</div>
						<div class="d-flex flex-column flex-grow-1 mr-2">
					...
					<div class="d-flex align-items-center flex-wrap mb-5">
						<div class="symbol symbol-50 symbol-light mr-5">
									<span class="symbol-label">
										<img src="${ctxStatic}/templates/2/assets/media/svg/misc/003-puzzle.svg" class="h-50 align-self-center" alt="" />
									</span>
						</div>
						<div class="d-flex flex-column flex-grow-1 mr-2">
					...
					<div class="d-flex align-items-center flex-wrap mb-5">
						<div class="symbol symbol-50 symbol-light mr-5">
									<span class="symbol-label">
										<img src="${ctxStatic}/templates/2/assets/media/svg/misc/005-bebo.svg" class="h-50 align-self-center" alt="" />
									</span>
						</div>
						<div class="d-flex flex-column flex-grow-1 mr-2">
					...
					<div class="d-flex align-items-center flex-wrap">
						<div class="symbol symbol-50 symbol-light mr-5">
									<span class="symbol-label">
										<img src="${ctxStatic}/templates/2/assets/media/svg/misc/014-kickstarter.svg" class="h-50 align-self-center" alt="" />
									</span>
						</div>
						<div class="d-flex flex-column flex-grow-1 mr-2">
							...
							<div class="d-flex flex-column mb-5 align-items-start">
								<div class="d-flex align-items-center">
									<div class="symbol symbol-circle symbol-40 mr-3">
										<%--										<img alt="Pic" src="${ctxStatic}/templates/2/assets/media/users/300_12.jpg" />--%>
									</div>
									<div>
							...
							<div class="d-flex flex-column mb-5 align-items-end">
								<div class="d-flex align-items-center">
									...
									<div class="symbol symbol-circle symbol-40 ml-3">
										<%--										<img alt="Pic" src="${ctxStatic}/templates/2/assets/media/users/300_21.jpg" />--%>
									</div>
								</div>
...
<script src="${ctxStatic}/templates/2/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js"></script>
<!--end::Page Vendors-->
<!--begin::Page Scripts(used by this page)-->
<%--<script src="${ctxStatic}/templates/2/assets/js/pages/widgets.js"></script>--%>
<!--end::Page Scripts-->
...
<script type="text/javascript">
	...
	_mainTabs.setHeight(document.body.clientHeight-60);
	var currentTab = null;
