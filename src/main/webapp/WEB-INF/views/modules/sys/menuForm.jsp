		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="type">
					<form:options items="${fns:getDictList('sys_menu_type')}"  class="input-xxlarge"  itemLabel="label" itemValue="value" htmlEscape="false"/>
				</form:select>
				<span class="help-inline">菜单类型,默认为空或普通,为操作菜单时</span>
			</div>
		</div>
        <div class="control-group">
            <label class="control-label">对象标识:</label>
            <div class="controls">
                <form:input path="objId" htmlEscape="false" maxlength="100" class="input-xxlarge"/>
