                        ...
                        <div class="box-header with-border">
							...
							<div id="myTabContent" class="tab-content">
							    <div class="tab-pane fade in active" id="bulletin">
									...
									<act:todoTask tbodyId="ticket" title="工作票待办" isToDo="1"  procDefKey="elecWorkTicket1,elecWorkTicket2,rlWorkTicket,reKongTicket,dhWorkTicket1,dhWorkTicket2,chuChenTicket,urgentRepairTicket,worktaskTicket,confinedSpaceTicket" url="${ctx}/wo/woWt/ticketTask" needVar="0" pageSize="5" func="loadPageData"></act:todoTask>
									...
									<act:todoTask tbodyId="smAccidentAnalysis" title="事故分析待办" isToDo="1"  procDefKey="smAccidentAnalysis" url="${ctx}/sm/smAccidentAnalysis/todoTask" needVar="0" pageSize="5" func="loadPageData"></act:todoTask>
									<act:todoTask tbodyId="smAccidentAnalysisDept" title="事故分析部门信息待办" isToDo="1"  procDefKey="smAccidentAnalysisDept" url="${ctx}/sm/smAccidentAnalysisDept/todoTask" needVar="0" pageSize="5" func="loadPageData"></act:todoTask>
									<act:todoTask tbodyId="woOt" title="操作票待办" isToDo="1"  procDefKey="operationTicket" url="${ctx}/wo/woOt/todoTask" needVar="0" pageSize="5" func="loadPageData"></act:todoTask>
									<div id="wztask_divId">
							    ...
							    <div class="tab-pane fade" id="rule">
									...
									<act:todoTask tbodyId="hisWoDefectMonthAnalysis" title="缺陷月度分析已办" isToDo="0"  procDefKey="wodefect_analysis" url="${ctx}/wo/woDefectMonthAnalysis/historicTask" needVar="0" pageSize="5" func="loadPageData"></act:todoTask>
									<act:todoTask tbodyId="hisSmAccidentAnalysisDept" title="事故分析部门信息已办" isToDo="0"  procDefKey="smAccidentAnalysisDept" url="${ctx}/sm/smAccidentAnalysisDept/historicTask" needVar="0" pageSize="5" func="loadPageData"></act:todoTask>
									<act:todoTask tbodyId="hisWoOt" title="操作票已办" isToDo="0"  procDefKey="operationTicket" url="${ctx}/wo/woOt/historicTask" needVar="0" pageSize="5" func="loadPageData"></act:todoTask>
            ...
            <div class="row">
                ...
                <!-- /.col -->
                 ...
                 <div class="col-md-6">
                    ...
                    <div class="box box-danger">
                        <div class="box-header with-border">
                            <h3  class="box-title">煤场管理中心消缺奖考核明细,统计当前月<span id="aa"></span></h3>
								<a href='#'  onclick='clickview1()'>查看其他月明细</a>
                            <div class="box-tools pull-right">
                                <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                                </button>
                                <div class="btn-group">
                        ...
                        <div class="box-body">
                            <div class="row">
                            <div id="datagridMain_defect_check_3" class="mini-datagrid"
									style="width: 99%; height: auto;margin-left: 5px;" allowResize="false"
									allowSortColumn="false" showPager="false" ondrawcell="onDrawCell_defect_check">
									<div property="columns">
										<div name="id" field="id" headerAlign="center" width="100" visible="false">统计项名称</div>
										<div name="name" field="name" headerAlign="center" width="100">统计项名称</div>
										<div name="byxz" field="item" headerAlign="center" width="100">项/率</div>
										<div name="byxc" field="value" headerAlign="center" width="100">金额</div>
										<div name="valueType"  field="valueType" headerAlign="center" type="comboboxcolumn" width="100">类型
											<input property="editor" class="mini-combobox"  valueField="value" textField="label" url="${ctx}/sys/dict/listDataStr?type=wo_defect_check_value_type" style="width:100%;"  />
										</div>
									</div>
								</div>
                            </div>
                            <!-- /.row -->
                             <div class="box-body">
                            <div class="row">
                                <div id="main5" style=" height:25px;"></div>
                                <!-- /.col -->
                                <div id="main5Desc" style=" height:20px;padding-left: 10px;">
                           			备注：<a href='#'  onclick='clickview1()'>查看考核规则</a>
...
<div class="row">
                ...
                <div class="col-md-6">
                    <div class="box box-danger">
                        <div class="box-header with-border">
                            <h3 class="box-title">检修部消缺奖考核明细,统计当前月<span id="bb"></span></h3>
                            <a href='#'  onclick='clickview1()'>查看其他月明细</a>
                             <div class="box-tools pull-right">
                                <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                                </button>
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div id="datagridMain_defect_check_1" class="mini-datagrid"
									style="width: 99%; height: auto;" allowResize="false"
									allowSortColumn="false" showPager="false" ondrawcell="onDrawCell_defect_check">
									<div property="columns">
										<div name="id" field="id" headerAlign="center" width="100" visible="false">统计项名称</div>
										<div name="name" field="name" headerAlign="center" width="100">统计项名称</div>
                            ...
                            <!-- /.row -->
                             <div class="box-body">
                            <div class="row">
                                <div id="main5" style=" height:20px;"></div>
                                <!-- /.col -->
                                <div id="main5Desc" style=" height:20px;padding-left: 10px;">
                           			备注：<a href='#'  onclick='clickview1()'>查看考核规则</a>
               ...
               <!-- Right col -->
                <div class="col-md-6">
                    ...
                    <div class="box box-danger">
                        <div class="box-header with-border">
                            <h3 class="box-title">运行部消缺奖考核明细,统计当前月<span id="cc"></span></h3>
							<a href='#'  onclick='clickview1()'>查看其他月明细</a>
                            <div class="box-tools pull-right">
                                <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                                </button>
                        ...
                        <div class="box-body">
                            <div class="row">
                            <div id="datagridMain_defect_check_2" class="mini-datagrid"
									style="width: 99%; height: auto;margin-left: 5px;" allowResize="false"
									allowSortColumn="false" showPager="false" ondrawcell="onDrawCell_defect_check">
									<div property="columns">
										<div name="id" field="id" headerAlign="center" width="100" visible="false">统计项名称</div>
...
<div class="row">
           ...
           // 	fetchCmsArticle(); //获取定期工作
            	...
            	onDaiBan();//加载待办任务
            	loadGrid();//加载整改通知
            	loadDefectCheck();//加载缺陷考核
            });
            
            function loadDefectCheck(){
            	mini.parse();
            	var data = {};
            	BiTool.loadGrid({
    				gridId : "datagridMain_defect_check_1",
    				url : "${ctx}/wo/woDefect/defectCheck?queryType=1",
    				requestData : data,
    				type:'string'
    			});
            	BiTool.loadGrid({
    				gridId : "datagridMain_defect_check_2",
    				url : "${ctx}/wo/woDefect/defectCheck?queryType=2",
    				requestData : data,
    				type:'string'
    			});
            	BiTool.loadGrid({
    				gridId : "datagridMain_defect_check_3",
    				url : "${ctx}/wo/woDefect/defectCheck?queryType=3",
    				requestData : data,
    				type:'string'
    			});
            	...
            	var date1= new Date();
            	a.innerHTML=" "+date1.getFullYear()+"-"+(date1.getMonth()+1);
            	b.innerHTML=" "+date1.getFullYear()+"-"+(date1.getMonth()+1);
            	c.innerHTML=" "+date1.getFullYear()+"-"+(date1.getMonth()+1);
            }
            ...
            function onDaiBan(){//点击待办时
            	...
            	toLoadTask("smAccidentAnalysis","${ctx}/sm/smAccidentAnalysis/todoTask",{procDefKey:'smAccidentAnalysis',pageSize:'5',needVar:"0"},'1');
            	toLoadTask("smAccidentAnalysisDept","${ctx}/sm/smAccidentAnalysisDept/todoTask",{procDefKey:'smAccidentAnalysisDept',pageSize:'5',needVar:"0"},'1');
            	toLoadTask("woOt","${ctx}/wo/woOt/todoTask",{procDefKey:'operationTicket',pageSize:'5',needVar:"0"},'1');
            }
            ...
            function onYiBan(){//点击已办时
            	...
            	toLoadTask("hisSmAccidentAnalysisDept","${ctx}/sm/smAccidentAnalysisDept/historicTask",{procDefKey:'smAccidentAnalysisDept',pageSize:'5',needVar:"1"},'0');
            	toLoadTask("hisWoOt","${ctx}/wo/woOt/historicTask",{procDefKey:'operationTicket',pageSize:'5',needVar:"1"},'0');
