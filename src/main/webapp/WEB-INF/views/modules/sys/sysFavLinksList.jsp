...
<body>
	   <sys:toolbargridsingle objId="SysFavLinks"  permissionEdit="sys:sysFavLinks:edit"></sys:toolbargridsingle>
       <sys:searchadv></sys:searchadv>
	   <div class="mini-fit">
		<div id="datagridMain" class="mini-datagrid" style="width:100%;height:100%;"
			 url="${ctx}/sys/sysFavLinks/data" idField="id"
		...
		>
			<div property="columns">
				...
				<div type="checkcolumn"></div>
					...
					<div name="isVisible" field="isVisible" vtype=""   headerAlign="center" allowSort="true" width="120" >是否可见
						<input property="editor" class="mini-textbox"  style="width:100%;"  />
						<input id="isVisible-Filter" name="mini-column-filter"  property="filter" class="mini-textbox" style="width:100%;"
							   onvaluechanged="onFilterChanged" showClose="true"  oncloseclick="onFilterClose(this)"
						/>
					</div>
					...
					<div name="isAutoOpen" field="isAutoOpen" vtype=""   headerAlign="center" allowSort="true" width="120" >是否自动打开
						<input property="editor" class="mini-textbox"  style="width:100%;"  />
						<input id="isAutoOpen-Filter" name="mini-column-filter"  property="filter" class="mini-textbox" style="width:100%;"
							   onvaluechanged="onFilterChanged" showClose="true"  oncloseclick="onFilterClose(this)"
						/>
					</div>
        </div>
...
<script type="text/javascript">
	...
	initBase(
			{   id:"datagridMain",
			    objId:"SysFavLinks",
				dataUrl:"${ctx}/sys/sysFavLinks/data",
				getUrl:"${ctx}/sys/sysFavLinks/get",
				saveUrl:"${ctx}/sys/sysFavLinks/save",
				removeUrl:"${ctx}/sys/sysFavLinks/remove",
				exportUrl:"${ctx}/sys/sysFavLinks/export"
			 }
	       );
