...
<body>
	   <sys:toolbargridsingle objId="SysQueryResult"  permissionEdit="sys:sysQueryResult:edit"></sys:toolbargridsingle>
		...
		>
			<div property="columns">
				...
				<div type="checkcolumn"></div>
					...
					<div name="queryCriteria" field="queryCriteria" vtype=""   headerAlign="center" allowSort="true" width="500" >查询条件
						<input property="editor" class="mini-textbox"  style="width:100%;"  />
						<input id="queryCriteria-Filter" name="mini-column-filter"  property="filter" class="mini-textbox" style="width:100%;"
							   onvaluechanged="onFilterChanged" showClose="true"  oncloseclick="onFilterClose(this)"
						/>
					</div>
					<div name="objId" field="objId" vtype="required"   headerAlign="center" allowSort="true" width="64" >对象编号
						<input property="editor" class="mini-textbox"  style="width:100%;"  />
					...
					<div name="url" field="url" vtype=""   headerAlign="center" allowSort="true" width="255" >URL
						<input property="editor" class="mini-textbox"  style="width:100%;"  />
