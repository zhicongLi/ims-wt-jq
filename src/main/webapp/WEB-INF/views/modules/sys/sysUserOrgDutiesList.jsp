...
<html>
<head>
	<title>人员机构岗位对应表</title>
	<meta name="decorator" content="default"/>
	<link href="${ctxStatic}/common/trepsui-ext.css" type="text/css" rel="stylesheet" />
</head>
<body>
	   <sys:toolbargridsingle objId="SysUserOrgDuties"  permissionEdit="sys:sysUserOrgDuties:edit"></sys:toolbargridsingle>
       <sys:searchadv></sys:searchadv>
	   <div class="mini-fit">
		<div id="datagridMain" class="mini-datagrid" style="width:100%;height:100%;"
			 url="${ctx}/sys/sysUserOrgDuties/data" idField="id"
		...
		>
			<div property="columns">
				...
				<div type="checkcolumn"></div>
					...
					<div name="orgDutiesId" field="orgDutiesId" vtype="required"   headerAlign="center" allowSort="true" width="100" >职位编码
						<input property="editor" class="mini-textbox"  style="width:100%;"  />
						<input id="orgDutiesId-Filter" name="mini-column-filter"  property="filter" class="mini-textbox" style="width:100%;"
							   onvaluechanged="onFilterChanged" showClose="true"  oncloseclick="onFilterClose(this)"
						/>
					</div>
...
<script type="text/javascript">
	...
	initBase(
			{   id:"datagridMain",
			    objId:"SysUserOrgDuties",
				dataUrl:"${ctx}/sys/sysUserOrgDuties/data",
				getUrl:"${ctx}/sys/sysUserOrgDuties/get",
				saveUrl:"${ctx}/sys/sysUserOrgDuties/save",
				removeUrl:"${ctx}/sys/sysUserOrgDuties/remove",
				exportUrl:"${ctx}/sys/sysUserOrgDuties/export"
			 }
	       );
