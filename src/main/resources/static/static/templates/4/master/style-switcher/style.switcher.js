var styleSwitcher = {
    ...
    initialize: function() {
        ...
        this.initialized || (a.options = $.extend({}, a.defaults), String.prototype.capitalize = function() {
            ...
            }, $.styleSwitcherCachedScript("static/templates/4/master/less/less.js").done(function(c, d) {
                $.ajax({
                    url: "static/templates/4/master/style-switcher/style.switcher.html"
                }).done(function(c) {
        ...
        }), $.styleSwitcherCachedScript("static/templates/4/master/style-switcher/cssbeautify/cssbeautify.js").done(function(a, b) {}))
    },
    build: function() {
        var a = this,
    ...
    setLogo: function(a) {
        ...
        a || ("#" + $.cookie("colorPrimary")).toUpperCase() == this.defaults.colorPrimary.toUpperCase() && "dark" != $.cookie("backgroundColor") ? b.attr("src", "static/images/logo.png") : "dark" == $.cookie("backgroundColor") || "dark" == $.cookie("headerColor") ? b.attr("src", "static/images/logo-light.png") : b.attr("src", "static/images/logo.png"), $.event.trigger({
