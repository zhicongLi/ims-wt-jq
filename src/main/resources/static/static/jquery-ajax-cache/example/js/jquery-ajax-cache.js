...
/***/ function(module, exports, __webpack_require__) {
	...
	var CacheProxy = exports.CacheProxy = (function () {
	    function CacheProxy(options) {
          ...
          //console.info('options111:', options);
            ...
            //console.info('this.forceRefresh:', this.forceRefresh);
	        this.storageMap = {
...
/***/ function(module, exports) {
	...
	function addFilterToJquery($ajaxCache) {
	    ...
	    $.ajaxPrefilter(function (options, originalOptions, jqXHR) {
            ...
            //console.info('22222:', cacheProxy );
	        var ajaxCacheOptions = options.ajaxCache;
            //console.info('ajaxCacheOptions:', ajaxCacheOptions);
            //console.info('originalOptions:', originalOptions);
            //console.info('options:', options);
	        if (ajaxCacheOptions) {
	            var storage = cacheProxy.getStorage(cacheProxy.storageType);
	            ...
	            try {
	                var cacheKey = cacheProxy.genCacheKey(options, originalOptions, cacheProxy.preGenCacheKey);
	                var value = storage.get(cacheKey);
                    //console.info('forceRefresh:', cacheProxy.forceRefresh);
	                // force reflash cache
	                if (cacheProxy.forceRefresh === true) {
	                ...
	                if (!value) {
	                    ...
	                    options.success = function (data) {
	                        ...
	                        if (typeof cacheProxy.timeout === 'number') {
	                            exp = cacheProxy.timeout;
	                        }
	                        try {
	                            var cacheValidateFun = cacheProxy.cacheValidate || cacheProxy.getCacheValidateFun();
	    ...
	    */
	    $.ajaxTransport("+*", function (options, originalOptions, jqXHR) {
	        var cacheProxy = $ajaxCache.getCacheProxy();
	        var ajaxCacheOptions = options.ajaxCache;
            //console.info('111111:', cacheProxy );
	        if (ajaxCacheOptions) {
	            var storage = cacheProxy.getStorage(cacheProxy.storageType);
	            ...
	            if (value && cacheProxy.forceRefresh !== true) {
