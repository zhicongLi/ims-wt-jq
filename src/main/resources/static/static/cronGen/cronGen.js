(function ($) {
    ...
    $.fn.extend({
        cronGen: function (options) {
            ...
            $('<li/>').html($('<a id="SecondlyTab" href="#Secondly">秒</a>')).appendTo(topMenu);
            ...
            $('<li/>', { 'class': 'active' }).html($('<a id="DailyTab" href="#Daily">日</a>')).appendTo(topMenu);
            ...
            var secondsTab = $("<div/>", { "class": "tab-pane", id: "Secondly" });
            ...
            $("<input/>",{type : "text", id : "secondStart_0", value : "1", style:"width:28px; height:15px;"}).appendTo(seconds2);
            $(seconds2).append("-");
            $("<input/>",{type : "text", id : "secondEnd_0", value : "2", style:"width:28px; height:15px;"}).appendTo(seconds2);
            $(seconds2).append("秒");
            ...
            $(seconds3).append("从");
            $("<input/>",{type : "text", id : "secondStart_1", value : "0", style:"width:28px; height:15px;"}).appendTo(seconds3);
            $(seconds3).append("秒开始,每");
            $("<input/>",{type : "text", id : "secondEnd_1", value : "1", style:"width:28px; height:15px;"}).appendTo(seconds3);
            ...
            $("<input/>",{type : "text", id : "minStart_0", value : "1", style:"width:28px; height:15px;"}).appendTo(minutes2);
            $(minutes2).append("-");
            $("<input/>",{type : "text", id : "minEnd_0", value : "2", style:"width:28px; height:15px;"}).appendTo(minutes2);
            $(minutes2).append("分钟");
            ...
            $(minutes3).append("从");
            $("<input/>",{type : "text", id : "minStart_1", value : "0", style:"width:28px; height:15px;"}).appendTo(minutes3);
            $(minutes3).append("分钟开始,每");
            $("<input/>",{type : "text", id : "minEnd_1", value : "1", style:"width:28px; height:15px;"}).appendTo(minutes3);
            ...
            $(hourly2).append("周期 从");
            $("<input/>",{type : "text", id : "hourStart_0", value : "1", style:"width:28px; height:15px;"}).appendTo(hourly2);
            $(hourly2).append("-");
            $("<input/>",{type : "text", id : "hourEnd_0", value : "2", style:"width:28px; height:15px;"}).appendTo(hourly2);
            $(hourly2).append("小时");
            ...
            $(hourly3).append("从");
            $("<input/>",{type : "text", id : "hourStart_1", value : "0", style:"width:28px; height:15px;"}).appendTo(hourly3);
            $(hourly3).append("小时开始,每");
            $("<input/>",{type : "text", id : "hourEnd_1", value : "1", style:"width:28px; height:15px;"}).appendTo(hourly3);
            ...
            var dailyTab = $("<div/>", { "class": "tab-pane active", id: "Daily" });
            ...
            $(daily2).append("周期 从");
            $("<input/>",{type : "text", id : "dayStart_0", value : "1", style:"width:28px; height:15px;"}).appendTo(daily2);
            $(daily2).append("-");
            $("<input/>",{type : "text", id : "dayEnd_0", value : "2", style:"width:28px; height:15px;"}).appendTo(daily2);
            $(daily2).append("日");
            ...
            $(daily3).append("从");
            $("<input/>",{type : "text", id : "dayStart_1", value : "1", style:"width:28px; height:15px;"}).appendTo(daily3);
            $(daily3).append("日开始,每");
            $("<input/>",{type : "text", id : "dayEnd_1", value : "1", style:"width:28px; height:15px;"}).appendTo(daily3);
            $(daily3).append("天执行一次");
            ...
            $(daily6).append("每月");
            $("<input/>",{type : "text", id : "dayStart_2", value : "1", style:"width:28px; height:15px;"}).appendTo(daily6);
            ...
            $("<input/>",{type : "text", id : "weekStart_0", value : "1", style:"width:28px; height:15px;"}).appendTo(weekly3);
            $(weekly3).append("-");
            $("<input/>",{type : "text", id : "weekEnd_0", value : "2", style:"width:28px; height:15px;"}).appendTo(weekly3);
            $(weekly3).appendTo(weeklyTab);
            
            var weekly4 = $("<div/>",{"class":"line"});
            $("<input/>",{type : "radio", value : "4", name : "week"}).appendTo(weekly4);
            $(weekly4).append("第");
            $("<input/>",{type : "text", id : "weekStart_1", value : "1", style:"width:28px; height:15px;"}).appendTo(weekly4);
            $(weekly4).append("周的星期");
            $("<input/>",{type : "text", id : "weekEnd_1", value : "1", style:"width:28px; height:15px;"}).appendTo(weekly4);
            ...
            $("<input/>",{type : "text", id : "weekStart_2", value : "1", style:"width:28px; height:15px;"}).appendTo(weekly5);
            ...
            $("<input/>",{type : "text", id : "monthStart_0", value : "1", style:"width:28px; height:15px;"}).appendTo(monthly3);
            $(monthly3).append("-");
            $("<input/>",{type : "text", id : "monthEnd_0", value : "2", style:"width:28px; height:15px;"}).appendTo(monthly3);
            $(monthly3).append("月");
            ...
            $(monthly4).append("从");
            $("<input/>",{type : "text", id : "monthStart_1", value : "1", style:"width:28px; height:15px;"}).appendTo(monthly4);
            $(monthly4).append("日开始,每");
            $("<input/>",{type : "text", id : "monthEnd_1", value : "1", style:"width:28px; height:15px;"}).appendTo(monthly4);
            ...
            $(yearly2).append("周期从");
            $("<input/>",{type : "text", id : "yearStart_0", value : "2016", style:"width:36px; height:15px;"}).appendTo(yearly2);
            $(yearly2).append("-");
            $("<input/>",{type : "text", id : "yearEnd_0", value : "2017", style:"width:36px; height:15px;"}).appendTo(yearly2);
            $(yearly2).append("年");
           ...
           var objId =  options.objId;
            ...
            resultsName = objId;
            inputElementM= mini.get(resultsName);
            $("#objId").prop("name", resultsName);
    ...
    var generate = function () {
        ...
        if(results){
	        ...
	        inputElementM.setValue(results);
	        //var displayElementM= mini.get(displayElement.id);
	        //displayElementM.setValue(results);
	        // Update display
