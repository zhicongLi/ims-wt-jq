...
<div id="{{= it.group_id }}" class="rules-group-container"> \
  <div class="rules-group-header"> \
    <div class="btn-group pull-right group-actions"> \
      <a  class="mini-button" iconCls="icon-add" id="_add_rule"> \
        <i class="{{= it.icons.add_rule }}"></i> {{= it.lang.add_rule }} \
      </a> \
      {{? it.settings.allow_groups===-1 || it.settings.allow_groups>=it.level }} \
        <a  class="mini-button" iconCls="icon-add" id="_add_group"> \
          <i class="{{= it.icons.add_group }}"></i> {{= it.lang.add_group }} \
        </a> \
      {{?}} \
      {{? it.level>1 }} \
        <a  class="mini-button" iconCls="icon-remove" id="_delete_group"> \
...
<div id="{{= it.rule_id }}" class="rule-container"> \
  <div class="rule-header"> \
    <div class="btn-group pull-right rule-actions"> \
      <a  class="mini-button" id="_delete_rule" data-delete="rule"> \
...
QueryBuilder.defaults({
    mongoOperators: {
        ...
        'in':               function(v) { return { '$in': v }; },//treps
